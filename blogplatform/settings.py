...
LOGIN_REDIRECT_URL = 'blog-home'  # Redirige vers la page d'accueil après connexion
LOGOUT_REDIRECT_URL = 'blog-home'  # Redirige vers la page d'accueil après déconnexion